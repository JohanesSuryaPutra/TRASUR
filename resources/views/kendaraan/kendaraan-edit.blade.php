                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-lg-5">
                                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                                    <div class="card-body">
                                                        <form action="{{ url('/kendaraan/update/' . $Kendaraan->id_kendaraan) }}"
                                                            ...
                                                            <div class="form-floating mb-3">
                                                                <input class="form-control" type="text"
                                                                    name="tipe_kendaraan" id="tipe_kendaraan" 
                                                            ...
                                                            <div class="form-floating mb-3">
                                                                <input class="form-control" type="text"
                                                                    name="daya_angkut" id="daya_angkut"
                                                                    placeholder="Kapasitas"
                                                                    value="{{ $Kendaraan->daya_angkut }}" />
                                                            ...
                                                            <div class="form-floating mb-3">
                                                                <select class="form-control"name="nama_rute" id="" value="{{ $Kendaraan->id_rute }}" >
                                                                    <option>--Pilih Rute--</option>
                                                                    @foreach ($Rute as $r)
                                                                        <option value="{{ $r->id_rute }}">{{ $r->nama_rute }}</option>
                                                                    @endforeach
                                                                </select>
                                                                <label for="nama_rute">Pilih Rute</label>
                                                            </div>
