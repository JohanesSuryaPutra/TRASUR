                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <table id="datatablesSimple">
                            <thead>
                                <tr align="center">
                                    <th style="width: 20%">Tipe Kendaraan</th>
                            ...
                            <tbody>
                                @foreach ($kendaraan as $k)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/kendaraan/edit/{{ $k->id_kendaraan }}"><img src="{{ asset('style/icons8-edit.svg') }}"></a>
                                            <a href="/kendaraan/Delete/{{ $k->id_kendaraan }}"><img src="{{ asset('style/icons8-trash.svg') }}"></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
