...
<head>
    ...
    <title>Kendaraan - Delete</title>
    <link href="https://cdn.jsdelivr.net/npm/simple-datatables@latest/dist/style.css" rel="stylesheet" />
    <link href="{{ asset('style/css/styles.css') }}" rel="stylesheet" />
    <link href="{{ asset('style/css2/styles.css') }}" rel="stylesheet" />
                                        ...
                                        <div class="col-lg-5">
                                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                                <div class="card-header">
                                                    <h3 class="text-center font-weight-light my-4">Want to Delete the Data?</h3>
                                                </div>
                                                <div class="card-body" align="center">
                                                    <input type="hidden" name="id" value="">
                                                    <button type="submit" class="btn btn-primary" name="yes">
                                                        <a href="{{ url('/kendaraan/yesDelete/'.$kendaraan->id_kendaraan) }}">
                                                            <font color='white'>Yes</font>
                                                        </a>
                                                    </button>
                                                    <button type="submit" class="btn btn-primary" name="no">
                                                        <a href="/kendaraan/noDelete">
