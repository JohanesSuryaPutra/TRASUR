                    ...
                    <div class="card mb-4">
                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ url('/pemesan/upload') }}" method="post"
                                            enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            <div class="form-floating mb-3">
                                                <input class="form-control" type="text" name='nama_pem' id="nama_pem" placeholder="Nama" />
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" type="text" name='no_telp' id="no_telp" placeholder="No telp" />
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" type="text" name='bayar' id="bayar" placeholder="Bayar" />
