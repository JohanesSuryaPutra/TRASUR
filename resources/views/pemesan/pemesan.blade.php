                        ...
                        <table id="datatablesSimple">
                            <thead>
                                <tr align="center">
                                    ...
                                    <th style="width: 20%">Nomor Telephone</th>
                            ...
                            <tbody>
                                @foreach ($pemesan as $pemesa)
                                    <tr>
                                        <td>{{ $pemesa->nama_pem }}</td>
                                        <td>{{ $pemesa->email }}</td>
                                        <td>{{ $pemesa->no_telp }}</td>
                                        <td>{{ $pemesa->tgl_lahir }}</td>
                                        <td>{{ $pemesa->bayar }}</td>
                                        <td>
                                            <a href="/pemesan/edit/{{ $pemesa->id_pemesan }}"><img src="{{ asset('style/icons8-edit.svg') }}"></a>
                                            <a href="/pemesan/Delete/{{ $pemesa->id_pemesan }}"><img src="{{ asset('style/icons8-trash.svg') }}"></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
